...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private class ListenForClientConnection implements Runnable {
        @Override
        public void run() {
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplication(), "Server ready", Toast.LENGTH_LONG).show();
                    }
                });
                while (true) {
                    Socket client = serverSocket.accept();
                    new Thread(new ListenForInput(client)).start();
                    runOnUiThread(new Runnable() {

                        @Override
                        public void run() {
                            // TODO Auto-generated method stub
                            Toast.makeText(getApplication(), "Connected to new Client", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            } catch (Exception e) {
                Log.e("Server Socket probs", e.toString());
            }
        }
    }

    private class ListenForInput implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (clientSocket.isOutputShutdown() || clientSocket.isInputShutdown()) {
                        break;
                    }
                    request = dis.readUTF();
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplication(), "Message Received"+request, Toast.LENGTH_LONG).show();
                ...
                Log.e("Client Data receive", e.toString());
            }

        }

        public ListenForInput(Socket client) {
